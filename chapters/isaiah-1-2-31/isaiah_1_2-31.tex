...
% Isaiah Context Grid
\configurableGrid{1}{Isaiah 1-12}{
    \textbf{\large Isaiah 1-5}
...
\begin{thesauce}
\sauceitem{In v6, there is no "soundness" in Zion. The Hebrew word \hebrew{מְתֹם} me.tom has the same root for "unblemished" or "whole". This is the same word used of the spotless lamb sacrifice needed for their coverings. It kinda plays in to the "bad sacrifices" – they have blemishes in themselves and their sacrifices.}

\sauceitem{In v13, just about every other time the word "convocations" is used in the Hebrew Bible, it has the word "holy" before it. Not these convocations!.}
