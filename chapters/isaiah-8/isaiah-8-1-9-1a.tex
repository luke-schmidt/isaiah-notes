...
\begin{biblicaloutline}[Isaiah 8:11-15]
    ...
    \begin{chiasticoutline}[]{.95em}{2em}
        ...
        \chiasticverse[A]{0}{
            \versenum{12} "Do not call conspiracy all that this people calls conspiracy, and do not \highlightpurple{fear} what they \highlightpurple{fear}, nor be in \highlightpurple{dread}.
        }
        ...
        \chiasticverse[A']{0}{
            \versenum{13b} Let him be your \highlightpurple{fear}, and let him be your \highlightpurple{dread}. And he will become a sanctuary,
        }
        {\vspace{2em}}
        \chiasticverse[A]{0}{
