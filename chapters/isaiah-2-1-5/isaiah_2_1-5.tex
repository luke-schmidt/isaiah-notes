...
\begin{biblicaloutline}[Isaiah 2:1-5]
    ...
    \begin{versesection}{2em}
        ...
        \poetryline and that we may \highlightorange{walk} in his paths.''
        ...
        \poetryline come, let us \highlightorange{walk}
...
\vspace{1em}
\begin{center}
\includegraphics[width=1\textwidth]{gen-2-map.png}
\end{center}
\vspace{1em}
...
\vspace{1em}
\hebrewword{Instruction}{תוֹרָה}{to.rah}{}

\hebrewword{Light}{אוֹר}{or}{}
...
\vspace{1em}
But then in verse 5, there's a striking call back to Israel herself: "O house of Jacob, come, let us walk in the \textit{light} (\hebrew{אור}) of the LORD." The very people through whom God's instruction was meant to flow to the nations are themselves called to walk in His light.
